...
public class JwtTokenProvider {
    ...
    public String getUserPk(String token) {
        return Jwts.parser().setSigningKey(JwtProps.SECRET).parseClaimsJws(token).getBody().getSubject();
    }
    ...
    public boolean validateToken(String jwtToken) {
        try {
            Jws<Claims> claims = Jwts.parser().setSigningKey(JwtProps.SECRET).parseClaimsJws(jwtToken);
